      ...
      <div className="flex-1 flex items-center justify-center px-8 py-12">
        <div className="w-full max-w-sm space-y-7">
          ...
          <div>
            ...
            <p className="text-sm text-[var(--text-muted)] mt-1.5">컬렉션을 시작하세요</p>
          </div>
          ...
          <div className="flex items-center justify-between text-xs">
            <p className="text-[var(--text-faint)]">데모 모드 — 새로고침 시 초기화</p>
            <Link href="/login" className="text-[var(--text-muted)] hover:text-[var(--accent)] transition-colors">
              로그인 →
            </Link>
          </div>
        </div>
